/*!
 *  @file QTImage2Mov/source/copyright.h
 *  QTImage2Mov
 *
...
#define COPYRIGHT "\015\013\tQTImage2Mov: $Copyright (c) 2010 INRETS / RJVB. All rights reserved.$\015\013"
...
#define XG_IDENTIFY()	"QTImage2Mov v" kQTImage2MovVersionStr " '" __FILE__ "'-[" __DATE__ "," __TIME__ "]"

#ifndef SWITCHES
#	ifdef DEBUG
#		define _IDENTIFY(s,i)	static const char *xg_id_string= "$Id: @(#) "XG_IDENTIFY()"-(\015\013\t\t" s "\015\013\t) DEBUG version" i " $"
#	else
#		define _IDENTIFY(s,i)	static volatile const char *xg_id_string= "$Id: @(#) "XG_IDENTIFY()"-(\015\013\t\t" s "\015\013\t)" i " $"
#	endif
#else
...
static volatile const char *xg_id_string_stub(){ _IDENTIFY(s,i);\
