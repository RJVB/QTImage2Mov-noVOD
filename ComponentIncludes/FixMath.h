...
*/
    ...
    /*
        ...
        // Return _Result.
         _Result;
    */
// 20110208 RJVB: until we have a better replacement for MSVC, use the simple PPC definition for IntSaturate:
#elif defined __ppc__ || __ppc64__ || defined(_MSC_VER)
